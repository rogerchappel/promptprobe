...
Replace this section with the supported versions for `promptprobe`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `promptprobe` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in promptprobe.
